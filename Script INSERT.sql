...
-- Insertar 20 reseñas con id_producto correcto (1–24)
INSERT INTO Resenas (id_cliente, id_producto, calificacion, comentario, fecha_resena) VALUES
(1, 1, 5, 'Excelente matcha, muy aromático.', '2025-08-01 10:00:00'),
(2, 2, 4, 'Buen matcha, un poco caro.', '2025-08-01 11:00:00'),
(3, 3, 5, 'Me encantó el matcha ceremonial premium.', '2025-08-01 12:00:00'),
(4, 4, 3, 'El houjicha está bien, esperaba más sabor.', '2025-08-01 13:00:00'),
(5, 5, 4, 'Latte delicioso, repetiré.', '2025-08-01 14:00:00'),
(6, 6, 5, 'El whisk es muy resistente y práctico.', '2025-08-01 15:00:00'),
(7, 7, 4, 'Baby whisk cumple su función.', '2025-08-01 16:00:00'),
(8, 8, 5, 'Base del whisk de excelente calidad.', '2025-08-01 17:00:00'),
(9, 9, 3, 'Removedor normal, nada especial.', '2025-08-01 18:00:00'),
(10, 10, 5, 'Bowl muy bonito y resistente.', '2025-08-01 19:00:00'),
(11, 11, 5, 'Kit completo, me encantó.', '2025-08-02 10:00:00'),
(12, 12, 4, 'Matcha cookie deliciosa.', '2025-08-02 11:00:00'),
(13, 13, 5, 'Greenies perfectos, muy ricos.', '2025-08-02 12:00:00'),
(14, 14, 4, 'SF cookies aceptables.', '2025-08-02 13:00:00'),
(15, 15, 3, 'SF matcha latte podría mejorar.', '2025-08-02 14:00:00'),
(16, 16, 5, 'Marquesas increíbles.', '2025-08-02 15:00:00'),
(17, 17, 4, 'Trufas ricas, pero pequeñas.', '2025-08-02 16:00:00'),
(18, 18, 5, 'Latte ceremonial exquisito.', '2025-08-02 17:00:00'),
(19, 19, 4, 'Latte houjicha muy bueno.', '2025-08-02 18:00:00'),
(20, 20, 5, 'Latte frío refrescante.', '2025-08-02 19:00:00');
...
-- DETALLE DE VENTAS corregido (solo id_venta 1–20 válidos)
